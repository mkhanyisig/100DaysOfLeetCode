"""
	Pramp Recursive Backtracking Solution
	
	Question: Write the function sudokuSolve that checks whether a given sudoku board (i.e. sudoku puzzle) is solvable. 
	If so, the function will return true. Otherwise (i.e. there is no valid solution to the given sudoku board), 
	returns false.
	
	a recursive algorithm that iterates through the empty cell on the board, and on the 
	possible candidate numbers for each empty cell, and tries to fill them
